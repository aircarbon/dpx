...
interface ISwapERC20 {
  ...
  function setProtocolFeeLight(uint256 _protocolFeeLight) external;

  function setProtocolFeeWallet(address _protocolFeeWallet) external;

  function setBonusMax(uint256 _bonusMax) external;

  function setBonusScale(uint256 _bonusScale) external;

  function setStaking(address _stakingToken) external;

  // State variable getters
  function protocolFee() external view returns (uint256);

  function protocolFeeLight() external view returns (uint256);

  function protocolFeeWallet() external view returns (address);

  function bonusScale() external view returns (uint256);

  function bonusMax() external view returns (uint256);
  ...
  // Ownership functions (from Solady Ownable)
